	...
	VCU_Support: {
		...
		bbis: {
			...
			paneRefresh: function(){
				...
				BBI.VCU_Support.bbis.multiStepGivingForm();
...
*/
	                    ...
	                    // Match Selected Fund to Hidden Fund
	                    $('select#billingCountry option').on('change', function () {
...
*/
			...
			multiStepGivingForm: function () {
				$(".giftTypeRdoList li input[type='radio']").click(function() {
					if ($("#recMonthly").not(":checked") && $('#giftFrequency:visible')) {
						$("#giftFrequency").addClass("invisible");
